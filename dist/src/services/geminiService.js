...
exports.adjustAmountSpendingData = exports.convertOcrToSpendingData = void 0;
// services/geminiService.ts
const genai_1 = require("@google/genai");
require('dotenv').config();
console.log("GEMINI_API_KEY: ", process.env.GEMINI_API_KEY);
const genAI = new genai_1.GoogleGenAI({ apiKey: process.env.GEMINI_API_KEY }); // Type assertion for process.env
...
exports.convertOcrToSpendingData = convertOcrToSpendingData;
const adjustAmountSpendingData = async (totalAmount, spendingData) => {
...
exports.adjustAmountSpendingData = adjustAmountSpendingData;
